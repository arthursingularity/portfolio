...
export default function Header() {
  return (
    <nav
      className="fixed top-0 left-0 right-0 z-40 bg-[#1a1e24]/90 backdrop-blur-md border-b border-[rgba(255,255,255,0.06)]"
    ...
    >
      <div className="max-w-md mx-auto px-6 h-[65px] flex items-center justify-between">
        ...
        <img src="/imagens/logo.svg" alt="Logo" className="w-11" />
